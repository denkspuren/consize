...
Until then consider using [google websites translator](https://translate.google.com/?op=websites) with the markdown [docs](https://github.com/denkspuren/consize/blob/master/doc/Consize.md). 
